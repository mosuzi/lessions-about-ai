...
| 数值精度/量化 | [INT4、INT8、FP8、FP16、BF16、FP32 都是啥](./01-numeric-precision-int-fp.md) | 本地跑模型或看模型新闻时有概念即可 |
...
[INT4/INT8/FP16/BF16/FP8](./01-numeric-precision-int-fp.md) 这类词主要影响本地模型的显存、速度和质量。如果你主要用云端 API 或 Codex/Claude Code，可以先知道即可。
